...
Route.create(name: '5X', internal_id: '5X', color: '21ba45', visible: false)
...
lexexn = ExpressLineDirection.create(line: lex, direction: 1, first_stop: "640N", last_stop: "621N")
lexexs = ExpressLineDirection.create(line: lex, direction: 3, first_stop: "621S", last_stop: "640S")
...
sixexn = ExpressLineDirection.create(line: sixav, direction: 1, first_stop: "D21N", last_stop: "D15N")
sixexs = ExpressLineDirection.create(line: sixav, direction: 3, first_stop: "D15S", last_stop: "D21S")
...
eigexn = ExpressLineDirection.create(line: eigav, direction: 1, first_stop: "A32N", last_stop: "A24N")
eigexs = ExpressLineDirection.create(line: eigav, direction: 3, first_stop: "A24S", last_stop: "A32S")
...
queensexn = ExpressLineDirection.create(line: queensblvd, direction: 1, first_stop: "G14N", last_stop: "G08N")
queensexs = ExpressLineDirection.create(line: queensblvd, direction: 3, first_stop: "G08S", last_stop: "G14S")
...
LineDirection.create(line: myrtle, direction: 1, first_stop: "M01N", last_stop: "M10N")
LineDirection.create(line: myrtle, direction: 3, first_stop: "M10S", last_stop: "M01S")
fultonexn = ExpressLineDirection.create(line: fulton, direction: 1, first_stop: "A55N", last_stop: "A46N")
fultonexs = ExpressLineDirection.create(line: fulton, direction: 3, first_stop: "A42S", last_stop: "A55S")
...
epkwyexn = ExpressLineDirection.create(line: epkwy, direction: 1, first_stop: "239N", last_stop: "234N") # TODO
